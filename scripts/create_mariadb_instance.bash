...
#	aws --profile $profile rds describe-db-instances --query "DBInstances[].Endpoint"
#[
#    {
#        "Port": 3306, 
...
#	If need to delete ...
#	aws --profile $profile rds delete-db-instance --db-instance-identifier queuedbinstanceid --skip-final-snapshot
...
echo "aws --profile $profile rds describe-db-instances --db-instance-identifier ${db_instance_identifier} --query \"DBInstances[].Endpoint\""
